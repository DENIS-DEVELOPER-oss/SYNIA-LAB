...
export function HeroSection() {
  return (
    <section className="py-20 md:py-32 bg-primary text-center text-primary-foreground">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center sm:space-x-4 space-y-4 sm:space-y-0">
          ...
          <Button asChild size="lg" variant="outline" className="w-full sm:w-auto transition-transform hover:scale-105 text-primary-foreground border-primary-foreground hover:bg-primary-foreground/10">
            <Link href="/courses">Explorar Cursos</Link>
          </Button>
          <Button asChild size="lg" variant="ghost" className="w-full sm:w-auto transition-transform hover:scale-105 text-primary-foreground hover:bg-primary-foreground/10">
